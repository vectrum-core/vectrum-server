...
const schema = new Schema({
  ...
  kid: { type: String, trim: true, required: true, unique: true, },
  kty: { type: String, trim: true, required: true, sparse: true, },
  crv: { type: String, trim: true, required: true, sparse: true, },

  d: { type: String, trim: true, }, // privkey part
  x: { type: String, trim: true, required: true, },
  y: { type: String, trim: true, required: true, },

  private: { type: Boolean, sparse: true, default: false, },
}, {
